...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        if (fontPath != null) {
            ...
            typeface = ResourcesCompat.getFont(getContext(), R.font.font_app);
//            Typeface typeface = Typeface.createFromAsset(context.getAssets(), "font/font_app.xml");
        }
    ...
    private void computeIndicatorRect() {
        ...
        mRectIndicatorHead.set(0, indicatorHeadCenterY - halfIndicatorSize,
                this.getRight(), indicatorHeadCenterY + halfIndicatorSize);
